...
| 10/3 | **Spatial Vectors** | Spatial Libraries: raster, sp, rgeos, rgdal. Integrating ‘traditional GIS’ analyses with statistical modelling.  Data intersection (e.g. connecting points with polygons and rasters), overlays, zonal statistics, measuring autocorrelation (e.g. Moran’s I), spatial regression models. | Project Proposal Due|
...
| 10/24 | **Version Control** | Managing code with “version control" using Github. Figshare and other data repositories. | Homework # 3 due |
| 10/31 | **Web output** | [HTML Widgets](http://www.htmlwidgets.org) | |
| 11/7 | **High Performance Computing** | Parallel processing and high performance computing in R  | Homework # 4 due  |
| 11/14 | **Software Integration** | Calling other programs from within R. | First Draft of Project due |
| 11/21 |  **Package Development** |  Package structure and necessary components.  Things to consider when developing an R package. | Peer review of project drafts |
