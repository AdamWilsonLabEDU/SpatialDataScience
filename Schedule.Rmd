...
| Week    |  Title   | Description |  Assignment | Package Presentation Group |
|:--|:--|:----------------------------------------|:------------|---:|
| 8/28    | **Introduction & Overview** | Course Motivation & Objectives. Workflow & repeatable research in an era of big data. Getting started with the R Project for Statistical Computing & RStudio.|  [R4DS Chapter 1](http://r4ds.had.co.nz/introduction.html) |
