...
tasks:
   ...
   - Build weighted average data set for each continent using `group_by()` followed by `summarise()` with the `weighted.mean()` of GDP that will be the black continent average line on the second plot.
