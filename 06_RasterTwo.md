...
This file is available as a [<i class="fa fa-file-text" aria-hidden="true"></i> R script here](06_RasterTwo.R).  Download this file and open it (or copy-paste into a new script) with RStudio so you can follow along.  
