...
<img src="peng-spectrum.jpg" alt="alt text" width="800">
...
<img src="peng-pipeline.jpg" alt="alt text" width="600">
...
<small>![alt text](lemon.png)</small>
...
<img src="phd-comic-vcs.gif" alt="alt text" width="400">
...
<img src="contrails.jpg" alt="alt text" width="400">
...
<img src="reinhart_rogoff_coding_error_0.png" alt="alt text" width="400">

---

<img src="reinhart_rogoff_econ_mag.png" alt="alt text" width="500">
...
## Scripted analyses are superior  {.columns-2}
  ...
  <img src="open-science.png" alt="alt text" width="200px">
...
<img src="r-project.jpg" alt="alt text" width="100">
...
<img src="markdown.png" alt="alt text" width="100">
...
<img src="knitr.png" alt="alt text" width="200">
...
<img src="pandoc-workflow-rmd-md.png" alt="alt text" height="500px">
...
<img src="git.png" alt="alt text" width="25%">
<img src="github.png" alt="alt text" width="25%">
<img src="bitbucket.png" alt="alt text" width="25%">

## Environment for reproducible research   {.columns-2}

<img src="rstudio.png" alt="alt text" width="10%">
...
<img src="figshare.png" alt="alt text" width="30%">
<img src="dryad.png" alt="alt text" width="30%">
<img src="zenodo.png" alt="alt text" width="30%">
...
<img src="VictoriaStoddenIASSISTJune2010-reasons-to.png" alt="alt text" width="600">
...
<img src="VictoriaStoddenIASSISTJune2010-reasons.png" alt="alt text" width="600">
<small>Stodden (IASSIST 2010) sampled American academics registered at the Machine Learning conference NIPS (134 responses from 593 requests (23%). Red = communitarian norms, Blue = private incentives</small>
...
[<i class="fa fa-file-code-o fa-3x" aria-hidden="true"></i> The R Script associated with this page is available here](demo/Demo.Rmd).  Download this file and open it (or copy-paste into a new script) with RStudio so you can follow along.  

## R Markdown

Cheatsheet:

<a href="https://www.rstudio.com/wp-content/uploads/2015/02/rmarkdown-cheatsheet.pdf"> <img src="rmarkdown.png" alt="alt text" width="400"></a>
...
<img src="rmarkdownwindow.png" alt="alt text" width="500">
...
<img src="Turdus-migratorius-002.jpg" alt="alt text" width="200">
