...
## Observations: 1,458
## Variables: 8
## $ faa   <chr> "04G", "06A", "06C", "06N", "09...
## $ name  <chr> "Lansdowne Airport", "Moton Fie...
## $ lat   <dbl> 41.13047, 32.46057, 41.98934, 4...
## $ lon   <dbl> -80.61958, -85.68003, -88.10124...
## $ alt   <int> 1044, 264, 801, 523, 11, 1593, ...
## $ tz    <dbl> -5, -6, -6, -5, -5, -5, -5, -5,...
## $ dst   <chr> "A", "A", "A", "A", "A", "A", "...
## $ tzone <chr> "America/New_York", "America/Ch...
```
