...
date: 2018-08-30 
subtitle: Write a script that reads in data, calculates a statistic, and then plots a distribution of a variable.
reading:
...
tasks:
  ...
  - Plot the distribution of the `Petal.Length` field as a histogram
  - Save the script
