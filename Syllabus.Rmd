...
1. convert data from varied formats or structures to a desirable format for analysis and visualization 2. clean, transform and merge data attributes/variables appropriately
...
5. use current analysis, presentation, and collaboration tools in the data science field.
