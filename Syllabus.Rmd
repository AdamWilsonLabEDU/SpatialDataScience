---
title: "Spatial Data Science Syllabus"
---
...
## Schedule 
Tuesdays/Thursdays 11-12:20pm in 144 Wilkeson Quad.  
...
1. Understand principles of data science and their application to the analysis of spatial data.
2. Develop reproducible data processing workflows to transform, visualize, and model spatial data.
3. Create dynamic reproducible research output including figures, maps, manuscripts, and websites.
...
### Homeworks (30%)
Four homework assignments will be assigned throughout the semester and due before class the following week.  Assignments will be provided via UBLearns as R scripts with embedded questions.   See full [Homework Description](http://adamwilson.us/SpatialDataScience/Homework.html) for more details.  
...
## Textbook
We will read [_R for Data Science_](http://r4ds.had.co.nz/) which is available online. All additional materials will be available through the course website (http://adamwilson.us/SpatialDataScience/).
