...
Readings: 
●	The Popularity of Data Analysis Software ~ Robert A. Muenchen
●	A (very) short introduction to R (12 pages) 
Data Gymnastics
...
Version Control
Managing code and research products in a “version control’ repository such as Github.  Figshare and other data repositories. 
Graphics
The “grammar” of graphics: ggplot2 and extensions (ggmap, rasterVis, etc.)
Spatial Data
Spatial Libraries: raster, sp, rgeos, rgdal. Integrating ‘traditional GIS’ analyses with statistical modelling.  Data intersection (e.g. connecting points with polygons and rasters), overlays, zonal statistics, measuring autocorrelation (e.g. Moran’s I), spatial regression models.
Readings:
●	Introduction to the Raster Package
Example Application: Species distribution modeling
Use of dismo and raster packages to model species distributions.
...
Introduction to foreach package and parallel processing.  
Software Integration
Language/software integration.  Use of the system() command.
 Calling various other programs from within R.
Package Development
Package structure and necessary components.  Things to consider when developing an R package. 
