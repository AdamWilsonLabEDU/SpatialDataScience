...
tasks:
  ...
  - Download [this zipfile](data/folder_structure/GEO503.zip) and move the folder structure into your new local repository (folder). Check your folder structure in your git repo to match the format for our class.
