...
tasks:
  ...
  - Save the script
  - Click 'Source' in RStudio to run the script from beginning to end
---
...
md_bullet(metadata$reading)
```

You are at a family gathering at Niagara Falls and your grandfather, who lives nearby, claims that summer temperatures are colder now than they were when he was a kid in the 1920s.  Your inner data scientist thinks this is an unlikely but you decide to look into it.  
...
You want to make a nice graphic to show your uncle at your next family gathering.  Be sure to include informative axis labels, a graph title, a graph subtitle describing the source of the data, the raw data, and a smoothed line showing the overal trend through time.
...
p1=ggplot(temp,aes(x=YEAR,y=JJA))+
  ...
  ggtitle("Mean Summer Temperatures in Buffalo, NY (1880-2018)",
          subtitle = "Data from the Global Historical Climate Network\n Red line is a LOESS smooth")+
  xlab("Year")
