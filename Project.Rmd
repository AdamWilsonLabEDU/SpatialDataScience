...
If you prefer to generate the graphics in R and then import them to another graphical layout program (Powerpoint, Adobe Illustrator, InkScape, etc.) that is acceptable.  But the core graphics must be produced using R.
...
* **Formatting:** Demonstrates mastery of R graphics and functions. Product uses an excellent mixture of headings, tables, and figures.
